...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1344: (t, s) => t.set(s),
      _1345: l => new DataView(new ArrayBuffer(l)),
      ...
      _1494: (o, p) => o[p],
      _1497: x0 => x0.random(),
      _1498: (x0,x1) => x0.getRandomValues(x1),
      _1499: () => globalThis.crypto,
...
" suggests you are here to learn about ",
"You may find yourself naturally drawn to situations that require ",
"Your greatest challenges often involve balancing your ",
" nature with practical needs.",
"Born on the ",
"th, you have natural ",
" abilities.",
"Your birthday number ",
" indicates you excel when you can be ",
"People often notice your ",
" qualities first.",
"Your name vibrates with the energy of ",
"You are meant to express yourself through ",
" activities.",
"Your life's work likely involves being ",
" in some way.",
"Deep down, you crave ",
" in your life.",
"Your soul is motivated by the desire to be ",
"You feel most fulfilled when you can express your ",
" nature.",
"Others often see you as ",
"Your outer personality projects ",
" energy.",
"First impressions of you often include being ",
"Leadership",
"Independence",
"Pioneer",
"Ambitious",
...
"\n\nNumber ",
"Leadership, independence, and pioneering spirit. You are a natural leader with strong willpower and determination.",
"Cooperation, diplomacy, and sensitivity. You work well with others and have a natural ability to mediate and bring harmony.",
"Creativity, communication, and self-expression. You are artistic, optimistic, and have a gift for inspiring others.",
"Stability, hard work, and practicality. You are reliable, organized, and excel at building solid foundations.",
"Freedom, adventure, and versatility. You crave variety and change, and have a natural curiosity about the world.",
"Nurturing, responsibility, and service. You are caring, protective, and have a strong sense of duty to family and community.",
"Spirituality, introspection, and analysis. You are a deep thinker who seeks truth and understanding through study and contemplation.",
"Material success, ambition, and authority. You have strong business acumen and the ability to achieve material wealth and recognition.",
"Humanitarianism, compassion, and universal love. You are generous, idealistic, and driven to serve the greater good.",
"A unique number with special significance in your numerological profile.",
"Your life path number reveals your life's purpose and the path you're meant to walk.",
"Your birthday number represents your natural talents and abilities.",
"Your expression number reveals your life's goal and what you're meant to accomplish.",
"Your soul urge number represents your inner desires and what motivates you.",
...
"Your life's goal and mission",
"Your inner desires and motivation",
"NumerologyType.",
"Born on ",
"Calculated on ",
"scrolledUnder",
